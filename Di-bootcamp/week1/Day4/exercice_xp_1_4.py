...
Original file is located at
    https://colab.research.google.com/drive/18zq9omgoXYldyCVUSbiDMImQvoT3ApDk
"""
    ...
    def check_majority(self, first_name):
        for person in self.members:
            if person.first_name == first_name:
                ...
                return
        print(f"Person with first name {first_name} not found in the family.")
